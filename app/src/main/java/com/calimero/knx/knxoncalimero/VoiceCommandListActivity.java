...
/**
 * An activity representing a list of VoiceCommands. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link VoiceCommandDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link VoiceCommandListFragment} and the item details
 * (if present) is a {@link VoiceCommandDetailFragment}.
 * <p/>
 * This activity also implements the required
 * {@link VoiceCommandListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class VoiceCommandListActivity extends Activity
        implements VoiceCommandListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voicecommand_list);

        if (findViewById(R.id.voicecommand_detail_container) != null) {
